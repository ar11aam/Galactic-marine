    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <h1 class="text-center my-4">Entries Without Word File</h1>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($cummin as $index => $cummins)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td> {{ $cummins->partNum }}</td>
                                            <td> {{ $cummins->partName }}</td>
                                            <td>
                                                <a href="/destroyCummins/{{ $cummins->id }}" class="btn btn-danger">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($zf as $index => $zfs)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td> {{ $zfs->partNum }}</td>
                                            <td> {{ $zfs->partName }}</td>
                                            <td>
                                                <a href="/destroyZfs/{{ $zfs->id }}" class="btn btn-danger">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
