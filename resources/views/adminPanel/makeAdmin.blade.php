        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Admin Details</h5>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                ...
                                <tbody>
                                    @foreach ($admin as $index => $admins)
                                        <tr>
                                            ...
                                            <td> {{ $admins->email }}</td>
                                            <td>
                                                <a href="/destroyAdmin/{{ $admins->id }}" class="btn btn-danger">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
                        ...
                        <p class="text-center">Note : Only 2 admins are allowed.</p>
                    </div>
