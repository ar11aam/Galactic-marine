...
<body data-spy="scroll" data-offset="40" id="home">
    ...
    <div class="container d-flex justify-content-center section-header my-5">
        <div class="pill-nav">
            ...
            <a class="active" href="{{ url('/solar') }}">Solar</a>
    ...
    <div class="section-header my-4">
        <div class="container">
            ...
            <div class="row">
                @if (is_countable($solar) && count($solar))
                    @foreach ($solar as $name)
    ...
    <div class="container my-4" style="border: 1px solid rgba(0, 0, 0, 0.482); border-radius: 10px; padding: 15px;">
        <div class="row">
            <div class="col">
                <li>Life P04 Battery-pack</li>
                <li>Power Quality Products</li>
                <li>Off Grind Inverter</li>

            </div>
            <div class="col">
                <li>MPPT solar charge & Discharge Controller</li>
                <li>AC Coverter / Battery Charger</li>
        ...
        <div class="row">
            <div class="col">
                ...
                <li>Solar Water RO</li>

            </div>
            <div class="col">
                <li>Solar Charger</li>
                <li>Solar-powered Refrigerator</li>
                <li>Solar Power Stirling Engine</li>
            </div>

        </div>
        <div class="row">
            <div class="col">
                <li>Step-Up & Step-down Transformer</li>
                <li>Uninterrupted Power Supply </li>
                <li>Solar Water Heater</li>
            </div>
            <div class="col">
                <li>Solar Pumped Laser</li>
                <li>Solar Roadway </li>
                <li>Solar Still</li>
            </div>
        </div>
