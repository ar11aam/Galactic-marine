...
<body data-spy="scroll" data-offset="40" id="home">
    ...
    <div class="container d-flex justify-content-center section-header my-5">
        <div class="pill-nav">
            ...
            <a class="active" href="{{ url('/traffic') }}">Traffic equipments</a>
    ...
    <div class="section-header my-4">
        <div class="container">
            ...
            <h3 class="text-center my-3">Items we have : </h3>

            <div class="row">
                @if (is_countable($traffic) && count($traffic))
                    @foreach ($traffic as $name)
    ...
    <div class="section-header my-4">
        <p> <b> Note : If you do not find your Part No. / Name of any brand, Just <a href="{{ '/contact' }}">
                    contact us </a>
